...
webpackConfig.devServer = (devServerConfig) => {
  // react-scripts 5 generates a dev server config using the webpack-dev-server v4
  // schema, but webpack-dev-server v5 is installed. Translate the removed options
  // (onBeforeSetupMiddleware / onAfterSetupMiddleware -> setupMiddlewares, https -> server)
  // so the config passes v5 schema validation.
